...
import Footer from "@/components/footer"; // Attempting to force re-evaluation
...
export default function ClientLayoutWrapper({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row w-screen h-[calc(100vh-64px)] min-h-[calc(100vh-64px)] relative z-10" style={{ height: 'calc(100vh - 64px)' }}>
        ...
        <main id="main-content" className="flex-1 lg:w-[75%] max-w-[75vw] h-full overflow-y-auto px-8 py-10 rounded-3xl bg-black/20 shadow-xl ml-0 lg:ml-8 w-full lg:ml-8">
