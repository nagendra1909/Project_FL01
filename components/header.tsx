...
import { navItems, scrollToSection } from "@/components/footer";
          ...
          {navItems.map((link, index) => (
            ...
            >
              <button
                ...
                onMouseEnter={link.id === 'about' && setAboutGlow ? () => setAboutGlow(true) : undefined}
                onMouseLeave={link.id === 'about' && setAboutGlow ? () => setAboutGlow(false) : undefined}
